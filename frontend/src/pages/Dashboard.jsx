...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [resumesResponse, jobsResponse, dashboardResponse] =
        await Promise.all([
          ...
          axios.get(`${API_URL}/api/export/dashboard/summary`, {
            headers: authHeaders
          })
        ])
      ...
      setStats({
        totalResumes:
          dashboardResponse.data?.statistics?.total_resumes ??
          resumesResponse.data?.length ??
          0,

        totalJobs:
          dashboardResponse.data?.statistics?.total_jobs ??
          jobsResponse.data?.length ??
          0,

        totalMatches:
          dashboardResponse.data?.statistics?.total_matches ?? 0,

        parsedResumes:
          dashboardResponse.data?.statistics?.parsed_resumes ?? 0,

        recentActivity:
          dashboardResponse.data?.recent_resumes ?? []
      })
    } catch (error) {
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm group-hover:text-blue-200">
                    Add a new resume for AI analysis
                  </p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <span className="text-white font-semibold text-lg group-hover:text-green-300">
                    Create Job Description
                  </span>

                  <p className="text-gray-300 text-sm group-hover:text-green-200">
                    Define requirements for new positions
                  </p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <span className="text-white font-semibold text-lg group-hover:text-purple-300">
                    View All Resumes
                  </span>

                  <p className="text-gray-300 text-sm group-hover:text-purple-200">
                    Browse and manage your resume library
                  </p>
                </div>
              </Link>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-300">
                    Define job requirements and skills for matching
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-300">
                    Use AI to find the best candidates automatically
                  </p>
                </div>
              </div>
