...
// Backend API URL from Vercel/Vite environment variable
...
const ResumeUpload = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setMessage(
        'Resume uploaded successfully! You can now parse it with AI.'
      )
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Upload your resume and let our AI analyze it to extract key
          ...
          <div className="text-center">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-300 mb-8 text-lg">
                Upload your resume in PDF or DOCX format. Maximum file size:
                10MB
              </p>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-6 bg-gray-700 rounded-2xl border border-gray-600">
                ...
                <p className="text-gray-300 text-sm">
                  Extract skills, experience, and contact information
                </p>
              ...
              <div className="text-center p-6 bg-gray-700 rounded-2xl border border-gray-600">
                ...
                <p className="text-gray-300 text-sm">
                  Match with job descriptions automatically
                </p>
